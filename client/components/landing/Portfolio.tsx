...
export default function Portfolio() {
  ...
  // Create duplicated projects for seamless loop
          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="overflow-hidden rounded-lg sm:rounded-xl mx-2 sm:mx-4 lg:mx-6">
              <div className="flex gap-1 sm:gap-2 lg:gap-3">
                {Array.from({ length: Math.floor(itemsPerView) || 1 }).map(
                  (_, index) => (
                    <div
                      key={index}
                      className="flex-shrink-0 px-1 sm:px-2 lg:px-3 animate-pulse"
                      style={{
                        width: `${100 / (Math.floor(itemsPerView) || 1)}%`,
                      }}
                    >
                        ...
                        <div className="p-4 sm:p-5 md:p-6 space-y-4">
                          ...
                          <div className="space-y-3">
                            {Array.from({ length: 3 }).map((_, i) => (
                              <div
                                key={i}
                                className="bg-[#1C1C1C]/50 rounded-lg p-3"
                              >
                          ...
                          <div className="pt-2 border-t border-[#3E3E3E]">
                            ...
                            <div className="flex gap-2">
                              {Array.from({ length: 3 }).map((_, i) => (
                                <div
                                  key={i}
                                  className="h-6 bg-[#3E3E3E] rounded-full w-16"
                                ></div>
                              ))}
                            </div>
                          </div>
