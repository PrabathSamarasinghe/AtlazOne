...
export default function Portfolio({ preloadedData }: PortfolioProps) {
  ...
  useEffect(() => {
    if (preloadedData) {
      setProjects(preloadedData);
      setLoading(false);
      console.log('✅ Portfolio using preloaded data:', preloadedData.length);
      return;
    }
