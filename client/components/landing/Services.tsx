...
import { useServices } from "@/contexts/DataCacheContext";
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 w-full max-w-6xl mx-auto px-4">
            {Array.from({ length: 4 }).map((_, index) => (
              <div key={index} className="animate-pulse">
                <div
                  className="flex flex-col p-6 sm:p-8 rounded-2xl border h-full"
                  style={{
                ...
                >
                  {/* Icon Skeleton */}
                  <div className="w-16 h-16 rounded-xl mb-6 bg-[#3E3E3E]"></div>

                  {/* Title Skeleton */}
                  <div className="h-6 bg-[#3E3E3E] rounded mb-4 w-3/4"></div>

                  {/* Description Skeleton */}
                  <div className="space-y-2 mb-6">
                    <div className="h-4 bg-[#3E3E3E] rounded"></div>
                    <div className="h-4 bg-[#3E3E3E] rounded w-5/6"></div>
                    <div className="h-4 bg-[#3E3E3E] rounded w-4/5"></div>
                  </div>

                  {/* Button Skeleton */}
                  <div className="h-12 bg-[#3E3E3E] rounded-full w-32 mt-auto"></div>
                </div>
              </div>
            ))}
          </div>
